...
-- +goose Down
DROP INDEX idx_vote_selections_option;
DROP INDEX idx_vote_selections_vote;
DROP INDEX idx_votes_category;
DROP INDEX idx_options_category;
DROP TABLE vote_selections;
DROP TABLE votes;
DROP TABLE options;
